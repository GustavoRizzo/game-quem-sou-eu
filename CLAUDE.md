...
- [lib/](lib/): módulos JS próprios reutilizáveis entre páginas/jogo, incluindo:
  ...
  - persistência: [match-repository.js](lib/match-repository.js), [settings-repository.js](lib/settings-repository.js), [word-lists-repository.js](lib/word-lists-repository.js) — storage injetável no construtor (testável em Node)
  - categorias: [categories.js](lib/categories.js) — registry de listas nativas + edições do usuário (diff de palavras desativadas + listas próprias do [word-lists-repository.js](lib/word-lists-repository.js)) mescladas; loader via fetch
