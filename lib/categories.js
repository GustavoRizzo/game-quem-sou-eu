...
export const CATEGORIES = [
  ...
  { id: 'frutas',           name: 'Frutas',            file: 'frutas.json' },
  { id: 'comidas-brasileiras', name: 'Comidas típicas brasileiras', file: 'comidas-brasileiras.json' },
  { id: 'esportes',         name: 'Esportes',          file: 'esportes.json' },
  { id: 'atletas',          name: 'Atletas',           file: 'atletas.json' },
  { id: 'espaco-sideral',   name: 'Espaço Sideral',    file: 'espaco-sideral.json' },
  { id: 'folclorico',       name: 'Folclórico',        file: 'folclorico.json' },
  { id: 'livros-classicos', name: 'Livros Clássicos',  file: 'livros-classicos.json' },
];
